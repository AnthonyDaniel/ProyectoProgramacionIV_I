...
export class AdminComponent implements OnInit {
  ...
  //Parking lot
  registerP() {
    console.log(this.registerParking);
  ...
  seeSpaces(park) {
    this.admin.getSpace(park).subscribe(
      data => {
        this.spaces = data;
      },
      error => console.log(error)
  ...
  modifySpace(s) {
    this.admin.modifySpace(s).subscribe(
      data=>{
        console.log(data);
      },
      error => {
  ...
  deleteSpace(s) {
    this.admin.deleteSpace(s).subscribe(
      data => {
        this.spaces = this.spaces.filter(h => h !== s);
        this.ngOnInit();
      },
      error => console.log(error)
    );
